...
func (obj *_APIProfilesMgr) WithIsDeleted(IsDeleted sql.NullTime) Option {
...
func (obj *_APIProfilesMgr) GetFromIsDeleted(IsDeleted sql.NullTime) (results []*APIProfiles, err error) {
