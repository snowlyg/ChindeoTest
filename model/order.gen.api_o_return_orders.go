...
func (obj *_APIOReturnOrdersMgr) WithIsDeleted(IsDeleted sql.NullTime) Option {
...
func (obj *_APIOReturnOrdersMgr) GetFromIsDeleted(IsDeleted sql.NullTime) (results []*APIOReturnOrders, err error) {
