...
func (obj *_APIAddrsMgr) WithIsDeleted(IsDeleted sql.NullTime) Option {
...
func (obj *_APIAddrsMgr) GetFromIsDeleted(IsDeleted sql.NullTime) (results []*APIAddrs, err error) {
