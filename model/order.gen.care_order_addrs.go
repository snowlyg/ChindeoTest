...
func (obj *_CareOrderAddrsMgr) WithIsDeleted(IsDeleted sql.NullTime) Option {
...
func (obj *_CareOrderAddrsMgr) GetFromIsDeleted(IsDeleted sql.NullTime) (results []*CareOrderAddrs, err error) {
