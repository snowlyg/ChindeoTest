...
func (obj *_APIMenuTypesMgr) WithIsDeleted(IsDeleted sql.NullTime) Option {
...
func (obj *_APIMenuTypesMgr) GetFromIsDeleted(IsDeleted sql.NullTime) (results []*APIMenuTypes, err error) {
