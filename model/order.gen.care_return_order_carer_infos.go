...
func (obj *_CareReturnOrderCarerInfosMgr) WithIsDeleted(isDeleted time.Time) Option {
...
func (obj *_CareReturnOrderCarerInfosMgr) GetFromIsDeleted(isDeleted time.Time) (results []*CareReturnOrderCarerInfos, err error) {
