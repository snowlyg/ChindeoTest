...
func (obj *_CareOrdersMgr) WithIsDeleted(isDeleted time.Time) Option {
...
func (obj *_CareOrdersMgr) GetFromIsDeleted(isDeleted time.Time) (results []*CareOrders, err error) {
