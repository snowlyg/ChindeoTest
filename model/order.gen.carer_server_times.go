...
func (obj *_CarerServerTimesMgr) WithIsDeleted(isDeleted time.Time) Option {
...
func (obj *_CarerServerTimesMgr) GetFromIsDeleted(isDeleted time.Time) (results []*CarerServerTimes, err error) {
