...
func (obj *_CareReturnOrderAddrsMgr) WithIsDeleted(isDeleted time.Time) Option {
...
func (obj *_CareReturnOrderAddrsMgr) GetFromIsDeleted(isDeleted time.Time) (results []*CareReturnOrderAddrs, err error) {
