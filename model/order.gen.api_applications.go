...
func (obj *_APIApplicationsMgr) WithIsDeleted(IsDeleted sql.NullTime) Option {
...
func (obj *_APIApplicationsMgr) GetFromIsDeleted(IsDeleted sql.NullTime) (results []*APIApplications, err error) {
