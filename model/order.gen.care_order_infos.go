...
func (obj *_CareOrderInfosMgr) WithIsDeleted(IsDeleted sql.NullTime) Option {
...
func (obj *_CareOrderInfosMgr) GetFromIsDeleted(IsDeleted sql.NullTime) (results []*CareOrderInfos, err error) {
