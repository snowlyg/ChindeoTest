...
func (obj *_CareOrderCarerInfosMgr) WithIsDeleted(isDeleted time.Time) Option {
...
func (obj *_CareOrderCarerInfosMgr) GetFromIsDeleted(isDeleted time.Time) (results []*CareOrderCarerInfos, err error) {
