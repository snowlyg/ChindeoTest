...
func (obj *_CareReturnOrdersMgr) WithIsDeleted(IsDeleted sql.NullTime) Option {
...
func (obj *_CareReturnOrdersMgr) GetFromIsDeleted(IsDeleted sql.NullTime) (results []*CareReturnOrders, err error) {
