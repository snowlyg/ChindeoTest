...
func (obj *_APIOOrdersMgr) WithIsDeleted(isDeleted time.Time) Option {
...
func (obj *_APIOOrdersMgr) GetFromIsDeleted(isDeleted time.Time) (results []*APIOOrders, err error) {
