...
func (obj *_CareTypesMgr) WithIsDeleted(isDeleted time.Time) Option {
...
func (obj *_CareTypesMgr) GetFromIsDeleted(isDeleted time.Time) (results []*CareTypes, err error) {
